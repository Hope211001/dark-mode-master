    ...
    return (
        <div className="fixed top-20 right-4 left-4 md:left-[272px] md:right-6 z-[200] pointer-events-none animate-in slide-in-from-top-2 fade-in duration-300">
            <div className="flex justify-end">
                <div className="pointer-events-auto flex items-start gap-3 bg-[#1e293b] border border-clay-500/30 rounded-xl px-4 py-3 md:px-5 md:py-4 shadow-2xl shadow-clay-500/10 w-full md:w-auto md:min-w-[340px] md:max-w-[440px]">
                    <div className="flex-shrink-0 mt-0.5">
                        <div className="h-8 w-8 md:h-9 md:w-9 rounded-full bg-clay-500/15 flex items-center justify-center">
                            <CheckCircle2 className="h-4 w-4 md:h-5 md:w-5 text-clay-400" />
                        </div>
                    </div>
                    <div className="flex-1 min-w-0">
                        <p className="text-xs md:text-sm font-semibold text-clay-400">Succès</p>
