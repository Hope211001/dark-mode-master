  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -left-[10%] w-[500px] h-[500px] bg-clay-500/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-[10%] -right-[10%] w-[500px] h-[500px] bg-clay-500/5 rounded-full blur-[120px]" />
      </div>
      ...
      <section className="relative z-10 pt-32 pb-12 md:pt-44 md:pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-clay-50 border border-clay-200 mb-8">
            ...
            <span className="text-xs md:text-sm font-medium text-clay-700 uppercase tracking-wide">Contactez-nous</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 leading-[1.1]">
            Une question ? <br className="hidden md:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-clay-600 to-clay-500">Parlons-en.</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-5 gap-8">
            <div className="md:col-span-2 space-y-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-clay-300 hover:shadow-md transition-all">
                <div className="w-12 h-12 bg-clay-50 rounded-xl flex items-center justify-center mb-4"><Mail className="text-clay-600" size={24} /></div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-clay-300 hover:shadow-md transition-all">
                <div className="w-12 h-12 bg-clay-50 rounded-xl flex items-center justify-center mb-4"><MapPin className="text-clay-600" size={24} /></div>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
                {sent ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    <div className="w-16 h-16 bg-clay-50 rounded-full flex items-center justify-center mb-6"><CheckCircle className="text-clay-600" size={32} /></div>
                    ...
                    <button onClick={() => { setSent(false); setForm({ name: "", email: "", subject: "", message: "" }); }} className="mt-8 text-clay-600 hover:text-clay-700 text-sm font-medium transition-colors">Envoyer un autre message</button>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-clay-500 focus:ring-1 focus:ring-clay-500/20 transition-colors placeholder:text-gray-400" placeholder="Votre nom" />
                      </div>
                      <div>
                        <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 block">Email</label>
                        <input type="email" required value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-clay-500 focus:ring-1 focus:ring-clay-500/20 transition-colors placeholder:text-gray-400" placeholder="votre@email.com" />
                      </div>
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 block">Sujet</label>
                      <input type="text" required value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-clay-500 focus:ring-1 focus:ring-clay-500/20 transition-colors placeholder:text-gray-400" placeholder="De quoi s'agit-il ?" />
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2 block">Message</label>
                      <textarea required rows={5} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-3 text-gray-900 text-sm focus:outline-none focus:border-clay-500 focus:ring-1 focus:ring-clay-500/20 transition-colors placeholder:text-gray-400 resize-none" placeholder="Votre message..." />
                    </div>
                    {error && (
                    ...
                    <button type="submit" disabled={sending} className="w-full bg-gradient-to-r from-clay-600 to-clay-600 text-white px-6 py-3.5 rounded-xl font-bold text-sm hover:from-clay-700 hover:to-clay-700 transition-all shadow-lg shadow-clay-600/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
