...
const statCards = [
  {
    ...
    label: "Total Leads",
    subtitle: "tous les leads détectés",
    icon: TrendingUp,
  ...
  {
    key: "contactedLeads" as keyof Stats,
    label: "Contactés",
  ...
  {
    key: "totalZones" as keyof Stats,
    label: "Total Zones",
    subtitle: "villes couvertes",
    icon: Map,
    gradient: "from-cyan-500/20 via-slate-900/90 to-slate-900/90",
  ...
  {
    key: "zonesVendues" as keyof Stats,
    label: "Zones vendues",
  ...
  {
    key: "zonesLibres" as keyof Stats,
    label: "Zones libres",
    subtitle: "disponibles",
    icon: MapPinOff,
    gradient: "from-rose-500/20 via-slate-900/90 to-slate-900/90",
...
const Dashbord = () => {
  ...
  const [stats, setStats] = useState<Stats>({
    ...
    totalZones: 0, zonesLibres: 0, zonesVendues: 0,
  });
  ...
  const fetchAllStats = async () => {
    try {
      ...
      const [allLeads, newLeads, contactedLeads, countAll, countLibre, countVendu] = await Promise.all([
                ...
                <CardContent className="relative p-4">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      <p className="text-[10px] md:text-xs font-medium text-slate-400 uppercase tracking-wide leading-tight">
                        {s.label}
                      </p>
